...
int S3[4][4];
int S4[4][4];
int S0updateResult[4][4];
int S1updateResult[4][4];
int S2updateResult[4][4];
int S3updateResult[4][4];
int S4updateResult[4][4];
...
uint8_t resultSend[16];

// AND functie
int ANDresult[4][4];

// Tag
unsigned long long int msglen = 16;  // in byte(s)!
...
int IV[4][4] =  {             {0xaa, 0xbb, 0x01, 0x01},
                              {0x01, 0x01, 0x69, 0x01},
                              {0x01, 0x01, 0x01, 0xFF},
                              {0x01, 0xdd, 0x01, 0x70},
                          };
